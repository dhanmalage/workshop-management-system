...
@section('content')
    <div class="row">
        <div class="col-lg-4">
            <h3 class="page-header">Invoices Report</h3>
        </div>
        <div class="col-lg-8">
            {!! Form::open(array('url' => url('reports.job-invoices'), 'id'=>'report-dates', 'class'=>'form-inline page-header-form')) !!}
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    @if(isset($new_date1_format) && isset($new_date2_format))
                        ...
                        <a href="{{url('reports.download_job_invoices/'.$new_date1_format.'/'.$new_date2_format)}}"  type="button" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> PDF Export</a>
                    @else
                        <a href="{{url('reports.download_job_invoices/')}}"  type="button" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> PDF Export</a>
                    @endif
                </div>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-function">
                            ...
                            @foreach($invoices as $invoice)
                                <tr class="odd gradeX">
									...
									<td><a href="{{url('invoices/'.$invoice->inv_id)}}" title="View">KAE/J-INV/{{$invoice->inv_id}}</a></td>
