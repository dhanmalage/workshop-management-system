        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                @endif
                    ...
                    {!! Form::open(array('url' => url('customers'), 'class'=>'form-horizontal')) !!}
                <div class="row">
                    <div class="col-lg-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            {!! Form::text('dob', null, ['class' => 'form-control', 'id' => 'promised-date', 'placeholder' => 'Date of Birth']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        {!! Form::label('how', 'How did you hear about us', ['class' => 'col-sm-4 control-label']) !!}
                        <div class="col-sm-8">
                            {!! Form::text('how', null, ['class' => 'form-control', 'placeholder' => 'How did you hear about us']) !!}
                        </div>
                    </div>
