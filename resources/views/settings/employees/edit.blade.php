            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        {!! Form::model($employee, ['action' => ['EmployeesController@update', $employee->id], 'role' => 'form', 'method' => 'PATCH', 'class'=>'form-horizontal']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('role_id', $roles, null, ['class' => 'form-control itemId', 'id' => 'role_id', 'required']) !!}
                        </div>
                    </div>
