...
@section('content')
    <div class="row">
        <div class="col-lg-3">
            <h3 class="page-header">Tax Edit</h3>
        </div><!-- /.col-lg-3 -->
        <div class="col-lg-9">
        ...
        <div class="col-lg-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model($tax, ['action' => ['TaxesController@update', $tax->id], 'role' => 'form', 'method' => 'PATCH', 'class'=>'form-horizontal']) !!}
                    ...
                    <div class="form-group">
                            {!! Form::label('name', 'Tax Value', ['class' => 'col-sm-3 control-label']) !!}
                        <div class="col-sm-9">
